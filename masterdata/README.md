...
|-----------|----------|------|-------------|--------|
| `distordia-type` | ✓ | string | Asset type identifier | `product` |
| `distordia-status` | ✓ | string | Lifecycle status | `valid`, `discontinued`, `recalled` |

### Identification Attributes

| Attribute | Required | Type | Description | Standard |
|-----------|----------|------|-------------|----------|
| `art-nr` | ✓ | string | Internal article/part number | Free text (max 50 chars) |
...
| Attribute | Required | Type | Description | Standard |
|-----------|----------|------|-------------|----------|
| `category` | ✓ | string | Human-readable product category | Free text (max 50 chars) |
...
**GPC**: GS1 Global Product Classification is an 8-digit code that provides standardized product categorization across industries. Essential for retail and GDSN synchronization. [Learn more →](https://www.gs1.org/standards/gpc)
...
| Attribute | Required | Type | Description | Standard |
|-----------|----------|------|-------------|----------|
| `description` | ✓ | string | Concise product description | Free text (max 100 chars) |
| `manufacturer` | ✓ | string | Manufacturer name or GLN | Free text or 13-digit GLN |
...
| Attribute | Required | Type | Description | Standard |
|-----------|----------|------|-------------|----------|
| `UOM` | ✓ | string | Base unit of measure | UN/CEFACT codes |
...
```
masterdata/
├── index.html       # Main HTML structure with form and modals
├── masterdata.css   # Styling including form sections and tables
├── masterdata.js    # Main UI logic and form handling
...
3. **Register New Product**
   ...
   - Click ℹ️ buttons for detailed field explanations
